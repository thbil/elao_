...
<html lang="fr">
    <head>
        ...
        <title>Elao_</title>
            ...
            <link rel="canonical" href="https://elao.github.io/elao_/pr/65/blog/tag/Stats.d" />
            <meta property="og:url" content="https://elao.github.io/elao_/pr/65/blog/tag/Stats.d" />
            ...
            <meta property="twitter:creator" content="@tom32i">
                    ...
                    <link rel="stylesheet" href="/elao_/pr/65/build/style.e93a0d66.css">
            </head>
    <body>
        <header class="header">
            <div class="container">
                    ...
                    <nav class="nav">
                        <ul>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/65/nos-services">
                                                                                <span>Nos services</span>
                                    </a>
                                </li>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/65/methodo">
                                                                                <span>Notre méthodologie</span>
                                    </a>
                                </li>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/65/nos-valeurs">
                                                                                <span>Nos valeurs</span>
                                    </a>
                                </li>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/65/la-tribu/">
                                                                                <span>La tribu</span>
                                    </a>
                                </li>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/65/blog/">
                                                                                <span>Blog</span>
                                    </a>
                                </li>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/65/contact">
                    ...
                    <nav class="nav-mobile">
                        ...
                        <ul>
                                    ...
                                    <a href="/elao_/pr/65/methodo">
                                                            ...
                                                            <li class="nav-mobile__item ">
                                    <a href="/elao_/pr/65/etudes-de-cas/">
        ...
        <main>
          ...
          <div>
                                                <div>
                        <img src="/elao_/pr/65/images/posts/thumbnails/rocket.jpg" />
                        18 juil. 2013
                                                    Tristan BESSOUSSA
                                                <a href="/elao_/pr/65/blog/infra/feedback-monitor-your-symfony2-application-via-stats-d-and-graphite.en">
                ...
                <section class="footer__links">
                    ...
                    <div class="links">
                        <ul>
                            <li>
                                <a href="/elao_/pr/65/nos-services">Nos services</a>
                            </li>
                            <li>
                                <a href="/elao_/pr/65/etudes-de-cas/">Nos études de cas</a>
                            </li>
                            <li>
                                <a href="/elao_/pr/65/blog/">Blog</a>
                            </li>
                            <li>
                                <a href="/elao_/pr/65/methodo">Notre méthodologie</a>
                            </li>
                            <li>
                                <a href="/elao_/pr/65/la-tribu/">La tribu</a>
                            </li>
                            <li>
                                <a href="/elao_/pr/65/contact">Contact</a>
                            </li>
                            <li>
                                <a href="/elao_/pr/65/nos-valeurs">Nos valeurs</a>
                            </li>
                            <li>
                                                                <a href="/elao_/pr/65/recrutement/">
                                    Nous recrutons
                ...
                <section class="footer__legals">
                    ...
                    <a href="/elao_/pr/65/legal">Mentions légales</a>
                    <a href="/elao_/pr/65/privacy">Protection des données</a>
                </section>
            </footer>
        </div>
                            <script src="/elao_/pr/65/build/runtime.065b3eec.js"></script><script src="/elao_/pr/65/build/0.4fc588e5.js"></script><script src="/elao_/pr/65/build/app.67723742.js"></script>
                    </body>
</html>
