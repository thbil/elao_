...
<html lang="fr">
    <head>
        ...
        <title>Elao_</title>
            ...
            <link rel="canonical" href="https://elao.github.io/elao_/pr/47/blog/tag/Stats.d" />
            <meta property="og:url" content="https://elao.github.io/elao_/pr/47/blog/tag/Stats.d" />
            ...
            <meta property="twitter:creator" content="@tom32i">
                    ...
                    <link rel="stylesheet" href="/elao_/pr/47/build/style.b0dbd031.css">
            </head>
    <body>
        <header class="header">
            <div class="container">
                    ...
                    <nav class="nav">
                        <ul>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/47/nos-services">
                                                                                <span>Nos services</span>
                                    </a>
                                </li>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/47/methodo">
                                                                                <span>Notre méthodologie</span>
                                    </a>
                                </li>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/47/nos-valeurs">
                                                                                <span>Nos valeurs</span>
                                    </a>
                                </li>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/47/la-tribu/">
                                                                                <span>La tribu</span>
                                    </a>
                                </li>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/47/blog/">
                                                                                <span>Blog</span>
                                    </a>
                                </li>
                                                            <li class="nav__item">
                                    <a href="/elao_/pr/47/contact">
                    ...
                    <nav class="nav-mobile">
                        ...
                        <ul>
                                    ...
                                    <a href="/elao_/pr/47/methodo">
                                                            ...
                                                            <li class="nav-mobile__item ">
                                    <a href="/elao_/pr/47/etudes-de-cas/">
        ...
        <main>
          ...
          <div>
                                                <div>
                        <img src="/elao_/pr/47/images/posts/thumbnails/rocket.jpg" />
                        18 juil. 2013
                                                    Tristan BESSOUSSA
                                                <a href="/elao_/pr/47/blog/infra/feedback-monitor-your-symfony2-application-via-stats-d-and-graphite.en">
                ...
                <section class="footer__legals">
                    ...
                    <a href="#">Protection des données</a>
                            ...
                            <script src="/elao_/pr/47/build/runtime.5bd2aab2.js"></script><script src="/elao_/pr/47/build/0.4fc588e5.js"></script><script src="/elao_/pr/47/build/app.67723742.js"></script>
                    </body>
</html>
